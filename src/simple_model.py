...
def preprocess_data(df):
    ...
    df = df.rename(columns={"valor_de_transacao_declarado_pelo_contribuinte": "transaction_value"})
...
def display_sample_predictions(model, X_test, y_test, df_original, sample_size=5):
...
def main():
    ...
    display_sample_predictions(model, X_test, y_test, df_original)
